...
def main():
    ...
    layout.add(
        ...
        .add(Paragraph("3", horizontal_alignment=Alignment.CENTERED,))
        .add(Paragraph("Place marker on a map", text_alignment=Alignment.CENTERED))
        .add(Paragraph("Ddirection V", text_alignment=Alignment.CENTERED))
        ...
        # row 2
        .add(Paragraph("1", horizontal_alignment=Alignment.CENTERED))
    ...
    # store
    with open("__pdf/test.pdf", "wb") as out_file_handle:
