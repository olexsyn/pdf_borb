...
def main():
    ...
    r2: Rectangle = Rectangle(
        Decimal(80), Decimal(80), Decimal(250), Decimal(100),
    ...
    stamp: Image = Image(
                        Path("/work/www/meteo/meteo.pp.ua/img/__stamp_meteo_4_pdf.png"),
                        width=Decimal(100),
                        height=Decimal(100),
    ...
    with open("borb_stamp.pdf", "wb") as pdf_file_handle:
    # store
